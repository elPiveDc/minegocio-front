# MiNegocio.com – Plataforma de Gestión Empresarial

MiNegocio.com es una aplicación web moderna diseñada para ayudar a pequeños emprendedores a gestionar sus ventas, inventarios, clientes y operaciones comerciales desde un entorno intuitivo, rápido y seguro.  
El sistema combina un backend robusto en Spring Boot con un frontend modular en React + TypeScript, junto a un módulo opcional de minijuego utilizado como demostración técnica y elemento interactivo.
...
- CSS / Bootstrap  
- Arquitectura modular (domain/models – infrastructure – ui – utils)
...
### Extra (Opcional – Minijuego)
- React + TypeScript  
- Arquitectura limpia (DDD simplificado)  
- JSON Server para pruebas  

---

## 📌 Descripción General

MiNegocio.com centraliza y organiza la información de pequeñas empresas, permitiendo gestionar:
...
El sistema está construido para ser escalable, mantenible y seguro, incorporando buenas prácticas como:
...
## 🕹️ Módulo Adicional: Minijuego (Opcional)

El repositorio incluye un minijuego tipo shooter desarrollado como:

- Demostración técnica del uso de arquitectura limpia  
- Ejemplo de integración con APIs y almacenamiento  
- Elemento interactivo para páginas 404, mantenimiento o tiempos de carga  

Este módulo es independiente del sistema principal y no interfiere con sus funciones empresariales.
